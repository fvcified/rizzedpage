...
const marqueeRows = [
  { direction: "left",  highlight: false, speed: 150, items: ["SOFTWARE ENGINEER","GAME DEVELOPER","FRONTEND DEVELOPER","BACKEND DEVELOPER","MOBILE DEVELOPER","CRYPTOGRAPHER","REVERSE ENGINEER","PENETRATION TESTER","RED TEAM","DEVOPS ENGINEER","DATA SCIENTIST","ML ENGINEER","CLOUD ENGINEER","FULL STACK","BLOCKCHAIN DEV","SECURITY RESEARCHER"] },
  ...
  { direction: "right", highlight: false, speed: 150, items: ["PENETRATION TESTING","METASPLOIT","WEB EXPLOITATION","CRYPTOGRAPHY","REVERSE ENGINEERING","PWN","FORENSICS","STEGANOGRAPHY","OSINT","HASHCAT","BURP SUITE","GHIDRA","WIRESHARK","KALI LINUX","ZERO DAY","FIREWALL","OWASP","NMAP","IDA PRO","BINARY EXPLOITATION","PRIVILEGE ESCALATION"] },
  ...
  { direction: "left",  highlight: true,  speed: 60,  items: ["SOFTWARE ENGINEER","GAME DEVELOPER","FRONTEND DEVELOPER","BACKEND DEVELOPER","MOBILE DEVELOPER","CRYPTOGRAPHER","REVERSE ENGINEER","PENETRATION TESTER","RED TEAM","DEVOPS ENGINEER","DATA SCIENTIST","ML ENGINEER","CLOUD ENGINEER","FULL STACK","BLOCKCHAIN DEV","SECURITY RESEARCHER"] },
  ...
  { direction: "left",  highlight: false, speed: 110, items: ["TENSORFLOW","PYTORCH","KERAS","SKLEARN","NUMPY","PANDAS","MATPLOTLIB","OPENAI","DEEPSEEK","OLLAMA","LANGCHAIN","HUGGINGFACE","NLP","COMPUTER VISION","REINFORCEMENT LEARNING","MOOD ANALYSIS","SIMULATION","RAG","FINE TUNING","VECTOR DB"] },
  { direction: "right", highlight: true,  speed: 30,  items: ["PENETRATION TESTING","MOOD ANALYSIS","WEB EXPLOITATION","CRYPTOGRAPHY","REVERSE ENGINEERING","PWN","FORENSICS","STEGANOGRAPHY","HASHCAT","METASPLOIT","OSINT","BURP SUITE","GHIDRA","WIRESHARK","KALI LINUX","ZERO DAY","FIREWALL","OWASP","NMAP","IDA PRO","BINARY EXPLOITATION","PRIVILEGE ESCALATION"] },
...
export default function Marquee() {
  ...
  useEffect(() => {
    ...
    marqueeRows.forEach(({ direction, highlight, speed, items }) => {
      ...
      row.style.animation = `${anim} ${speed * 2}s linear infinite`;
