                  ...
                  <div className="widget-stack">
                    <div id="activity-widget" className={`${hasActivity ? 'activity-active' : 'activity-inactive'} visible`}>
                      {hasActivity ? (
                        <>
                          <div
                            className="activity-icon-wrapper" style={{ display: 'flex' }}>
                              ...
                              return (
                                <div className="activity-small-icon-wrapper">
                                  <img
                                    ...
                                    loading="lazy"
                                    style={{ display: 'block' }}
                                    onError={(e) => { (e.target as HTMLImageElement).closest<HTMLElement>('.activity-small-icon-wrapper')!.style.display = 'none'; }}
                                  />
                                  {smallTooltipText && (
