export default function AboutSection() {
  return (
    <section className="about-footer-section" id="about-me">
      <div className="about-container">
        <div className="about-bg">
          ...
          <p className="about-description">
            ...
            Always experimenting to see what works. Proper into building clean, functional experiences, messing around with{' '}
            <span className="about-hover">research, development, and security stuff through code.</span>
          </p>
        </div>
      </div>
    </section>
